...
<head>
    ...
    <title>Admin Kepala Sekolah</title>
    <style>
        /* Import Google Font */
...
<body>
    ...
    <div class="container">
        <!-- Header -->
        <header class="header">
            <h1>ADMIN || DAFTAR KEPALA SEKOLAH</h1>
    ...
    <div id="overlayChangePass">
        <form action="/admin/set_password_kepsek" method="post">
    ...
    <script>
        function onChangePassword(id) {
            ...
            document.querySelector('#overlayChangePass form').action = "/admin/set_password_kepsek/" + id;
        }
        ...
        function onDeleteEmail(id) {
            document.getElementById('deleteForm').action = "/admin/delete_kepsek/" + id;
